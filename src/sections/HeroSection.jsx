    ...
    <section className="bg-white text-text font-body">
      <Container className="grid items-center gap-4 py-4 md:grid-cols-2 lg:gap-16 lg:py-8">
        ...
        >
          ...
          {/* CTA */}
          <BoockBtn className="relative mt-4 inline-flex w-full max-w-sm items-center justify-center rounded-xl bg-primary px-10 py-2 text-lg font-bold text-white shadow-card md:mx-0" btnnamed={"I Want IN - Reserve My Slot!"} onClick={handleOpenBookingModal} />
        </motion.div>
